...
class Reservas extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'comienza'=>array( self::STAT, 'ReservasServicios', 'idReserva','select'=>'FROM_UNIXTIME(MIN(fechaInicio))'),
	...
	public function todas($ano)
	{
		...
		foreach($res as $r){
			...
			$class=$this->tieneGastro($r->servicios)?'gastro':'';
